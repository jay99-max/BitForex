...
import { Shield, TrendingUp, Users, Send } from 'lucide-react'
import { useNavigate } from 'react-router-dom'
import { useContext } from 'react'  // ← FIXED: Import from 'react'
...
export default function Landing() {
  ...
  const testimonials = [
    { name: 'Michael R.', role: 'Tech Entrepreneur', quote: 'BitForex is the best — 9.2% APY changed everything.' },
    { name: 'Sarah L.', role: 'Financial Advisor', quote: 'Secure, compliant, and transparent. BitForex is unmatched.' },
    { name: 'David K.', role: 'Retired Investor', quote: 'From $2K to $5K+ in months. BitForex is the best.' },
    { name: 'Emily T.', role: 'Business Owner', quote: 'Intuitive and secure. BitForex is the best crypto platform.' },
  ]
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <motion.div className="text-center mb-20">
          <button
            ...
            className="group inline-flex items-center gap-3 rounded-xl bg-gradient-to-r from-teal-600 to-cyan-600 px-12 py-5 font-bold text-xl text-white hover-glow hover:scale-105"
          >
        ...
        <section className="py-16">
          <motion.h2 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className="mb-12 text-center text-3xl md:text-4xl font-bold text-transparent bg-gradient-to-r from-teal-400 via-cyan-400 to-teal-400 bg-clip-text crypto-font">
            {t.testimonialsTitle}
          </motion.h2>
